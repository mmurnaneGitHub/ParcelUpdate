:: *****************************************************************************
:: UpdateParcels.bat  10/22/2019 for ArcMap 10.7.1 
...
Echo Step 2 - Creating new parcels in \\geobase-win\ced\GADS\R2014\R506\Process\data\Pierce_County.gdb... >> %LogDir%%theDate%.log
 ::C:\Python27\ArcGISx6410.7\python.exe \\geobase-win\ced\GADS\R2014\R506\Process\ParcelUpdate1.py 1>>%LogDir%%theDate%.log 2>&1
